...
public class MenuService {
    ...
    * */
    ...
    public List<MenuDTO> seleectAllMenu() {

        // 세션 열어주기
        SqlSession sqlSession = getSqlSession();

        // MenuDAO를 이용해 데이터베이스에서 menuList 가져오기
        List<MenuDTO> menuList = menuDAO.selelctAllMenu(sqlSession);
    ...
    public boolean registMenu(MenuDTO menu) {
        ...
        // result 결과값에 다라서 insert, update, delete는 트랜젝션 처리를 해줘야 함.
